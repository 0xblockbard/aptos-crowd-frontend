...
@section('content')
    ...
    <div class="bg-indigo-50 overflow-hidden w-full">
        <div class="relative max-w-7xl mx-auto py-8 sm:py-10 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto text-base max-w-full mt-4">
                <div class="flex flex-col items-center w-full">
                    <h2 class="text-base text-indigo-500 font-semibold tracking-wide uppercase">Welcome</h2>
                    <div>
                        ...
                        <div class="w-40 sm:w-48 border border-indigo-400 mt-2 mb-2 ml-auto pr-4"></div>
                    </div>
                </div>

                <div class="flex flex-col sm:flex-row mt-8 px-20 sm:px-0 sm:space-x-12">
                    
                    <a class="flex w-full sm:w-1/3"  href="{{ route('show_all_campaigns') }}">
                        <div class="flex flex-col rounded-md shadow-md border border-indigo-400 px-8 py-6 hover:shadow-xl shadow-indigo-400 hover:border-indigo-500 transition duration-300 ease-in-out hover:scale-[1.05] hover:cursor-pointer hover:border-2"> 
                            <h2 class="font-roboto font-bold text-xl text-center">Explore Campaigns</h2>
                            <div class="w-20 border border-indigo-500 mt-1 mb-4 mx-auto"></div>
                            ...
                            <p class="font-merriweather mt-6 sm:px-6 text-center text-sm font-medium">Discover innovative campaigns and projects to support!</p>
                    ...
                    <a class="flex w-full sm:w-1/3 mt-10 sm:mt-0" href="{{ route('create_campaign') }}">
                        <div class="flex flex-col rounded-md shadow-md border border-indigo-400 px-8 py-6 hover:shadow-xl shadow-indigo-400 hover:border-indigo-500 transition duration-300 ease-in-out hover:scale-[1.05] hover:cursor-pointer hover:border-2"> 
                            <h2 class="font-roboto font-bold text-xl text-center">Start Campaign</h2>
                            <div class="w-14 border border-indigo-500 mt-1 mb-4 mx-auto"></div>
                    ...
                    <a class="flex w-full sm:w-1/3 mt-10 sm:mt-0" href="{{ route('guide') }}">
                        <div class="flex flex-col rounded-md shadow-md border border-indigo-400 px-8 py-6 hover:shadow-xl shadow-indigo-400 hover:border-indigo-500 transition duration-300ease-in-out hover:scale-[1.05] hover:cursor-pointer hover:border-2"> 
                            ...
                            <p class="font-merriweather mt-6 sm:px-4 text-center text-sm font-medium">Read more about our crowdfunding models and how they work</p>
