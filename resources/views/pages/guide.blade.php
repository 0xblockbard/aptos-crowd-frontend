...
@section('content')
    ...
    <div class="flex w-full py-24 shadow-md" style="background-image: url('https://res.cloudinary.com/blockbard/image/upload/c_scale,w_auto,q_auto,f_auto,fl_lossy/v1728199591/header-5.png'); background-size: cover; background-position: center;">
        <div class="max-w-7xl">
            <div class="flex flex-col ml-40 bg-white opacity-90 px-12 py-4 rounded-md"> 
                <h3 class="text-3xl text-indigo-600 font-extrabold">Guide</h3>
    ...
    <div class="flex flex-col w-full sm:w-10/12 xl:w-9/12 px-12 pt-16 pb-24 m-auto">
        ...
        <div class="flex flex-col pl-3">
            ...
            <div class="bg-sky-50 border-2 border-indigo-400 p-4 rounded-md shadow-lg shadow-indigo-300">
                
                <div class="mt-2 px-10 py-6 text-gray-600 space-y-6">

                    <h2 class="font-semibold text-2xl">Overview of AptosCrowd</h2>
                    
                    <p><span class="font-semibold text-indigo-600">AptosCrowd</span> is built upon the crowdfunding models outlined in <a class="text-indigo-600 hover:underline" href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2447567" target="_blank">Schwienbacher's (2000) research</a> on Keep-It-All and All-Or-Nothing strategies.</p>
                    ...
                    <p>The <span class="font-semibold text-indigo-600">AptosCrowd</span> demo is deployed on the Aptos Testnet and showcases sample crowdfunding campaigns using both the KIA and AON models.</p>
