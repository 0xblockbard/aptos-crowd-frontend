        ...
        <div class="relative max-w-7xl mx-auto py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
                <div>
                    ...
                    <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-indigo-600 sm:text-4xl">About AptosCrowd</h3>
                </div>
            </div>
            <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
                <div class="relative lg:row-start-1 lg:col-start-2">
                    ...
                    <div id="about_image" class="relative text-base mx-auto max-w-prose lg:max-w-none pl-20">
                        <figure>
                            <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
                                <img class="rounded-lg shadow-lg object-cover object-center" src="https://aptos-blockbard.s3.ap-southeast-2.amazonaws.com/aptos-crowdfund/crowdfunding-about.png" alt="Crowdfunding the future, one idea at a time">
                            </div>
                    ...
                    {{-- <div class="hidden sm:flex mt-48 relative text-base mx-auto max-w-prose lg:max-w-none pl-10">
                        <figure>
                            <div class="aspect-w-12 aspect-h-7 lg:aspect-none">
