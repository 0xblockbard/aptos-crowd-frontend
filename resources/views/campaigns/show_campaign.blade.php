                ...
                <div class="relative mt-3 pt-1">
                    <div class="flex mb-2 items-center justify-between">
                        ...
                        <div class="text-right">
                            <span id="contributed_amount" class="contributed_amount text-xs font-semibold inline-block text-indigo-600">
                                X
                            </span>
                            <span class="text-xs font-semibold inline-block text-indigo-600">
                                /
                            </span>
                            <span id="target_amount" class="target_amount text-xs font-semibold inline-block text-indigo-600">
                                XXX
                            </span>
                            <span class="text-xs font-semibold inline-block text-indigo-600">
                                APT
                    ...
                    <div class="overflow-hidden h-2 mb-2 text-xs flex rounded bg-indigo-200">
                        <div id="progress_bar" style="width:30%" class="progress_bar shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-indigo-500"></div>
                    </div>
                    <div class="flex justify-between mb-3 pl-1 pr-1">
{{-- 
                        <div class="flex text-sm">
                            <span class="backers font-extrabold pr-2 text-indigo-600">XX</span>
                            <span>supporters</span>
                        </div> --}}

                        <div class="flex text-sm days_remaining_container">
                            <span id="days_remaining" class="days_remaining font-extrabold pr-1 text-indigo-600">30</span>
                ...
                <div id="contribute_form" class="contribute_form mt-3">
                    <label for="contribution" class="block text-sm text-indigo-700 font-bold">Support This Campaign:</label>
                    <div class="mt-3 flex rounded-md shadow-sm">
                        <div class="relative flex items-stretch flex-grow focus-within:z-10">
                            <input type="text" name="contribution" id="contribution" class="contribution border focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-none rounded-l-md pl-4 sm:text-sm border-gray-300" placeholder="Pledge Amount" />
                        </div>
