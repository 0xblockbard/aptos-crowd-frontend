    ...
    <div class="flex w-full py-24" style="background-image: url('https://res.cloudinary.com/blockbard/image/upload/c_scale,w_auto,q_auto,f_auto,fl_lossy/v1728199270/header-3.png'); background-size: cover; background-position: center;">
        <div class="max-w-7xl">
            <div class="flex flex-col ml-16 sm:ml-40 bg-white opacity-90 px-12 py-4 rounded-md"> 
                <h3 class="text-3xl text-indigo-600 font-extrabold">Edit Campaign</h3>
            ...
            <div class="flex flex-row mb-8">
                ...
                <div class="flex flex-col w-full pr-1">
                    ...
                    <div class="w-full px-3">
                        ...
                        <input id="name" autocomplete="off" class="name appearance-none shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full px-2 py-2 sm:text-sm border border-gray-300 rounded-md" type="text" placeholder="Campaign title">
                    </div>
                    ...
                    <div class="w-full px-3 mt-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="start_imagedate">
                            ...
                            <input id="image_url" autocomplete="off" class="image_url appearance-none shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full px-2 py-2 sm:text-sm border border-gray-300 rounded-md" type="text" placeholder="Full url or ipfs://">
                    </div>
