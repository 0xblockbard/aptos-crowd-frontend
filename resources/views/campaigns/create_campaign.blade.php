                ...
                <div class="flex flex-col w-full pl-1">
                    ...
                    <div class="w-full px-3 mb-6 md:mb-0 sm:mt-6">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="text" name="funding_goal" id="funding_goal" class="funding_goal px-2 py-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full  pr-12 sm:text-sm border border-gray-300 rounded-md" placeholder="Your crowdfunding target">
